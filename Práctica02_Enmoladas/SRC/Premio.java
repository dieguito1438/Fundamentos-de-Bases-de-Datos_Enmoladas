...
public class Premio implements ArchivoCSV{
    ...
    public static class Builder{
        ...
        private CategoriaPremio categoria;
        /**Rango del edad para el canje del Premio*/
        private RangoEdad rangoEdad;
        /**Valor monetario aproximado del premio*/
        private double valorAproximado;
        ...
        /**
         * @param idPremio Llave del Premio 
         * @return Llave del Premio "Clase premio"
         */
        public Builder idPremio(int idPremio) {
            this.idPremio = idPremio;
            return this;
        }
        ...
        /**
         * @param nombre Nombre del premio
         * @return Nombre del premio "Clase premio"
         */
        ...
        /**
         * @param categoria Categoria del premio
         * @return Categoria del premio "Clase premio"
         */
        public Builder categoria(CategoriaPremio categoria) {
            this.categoria = categoria;
            return this;
        }
        /**
         * @param rangoEdad Rango del edad para el canje del Premio
         * @return Rango del edad para el canje del Premio "clase premio"
         */
        public Builder rangoEdad(RangoEdad rangoEdad) {
            this.rangoEdad = rangoEdad;
            return this;
        }
        /**
         * @param valorAproximado Valor monetario aproximado del premio
         * @return Valor monetario aproximado del premio "Clase premio"
         */
        public Builder valorAproximado(double valorAproximado) {
            this.valorAproximado = valorAproximado;
            return this;
        }
        /**
         * @param puntosNecesarios Puntos necesarios para canjear el premio
         * @return Puntos necesarios para canjear el premio "CLase premio"
         */
        public Builder puntosNecesarios(int puntosNecesarios) {
            this.puntosNecesarios = puntosNecesarios;
            return this;
        }
        /**
